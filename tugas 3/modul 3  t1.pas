...
nilai :=((0.1*absen)+(0.2*tugas)+(0.3*quiz)+(0.4*uas)+(0.4*uts))/2;
...
Huruf_Mutu:='C'
else if (niali>40) and (nilai<55) then
Huruf_Mutu:='D'
...
Huruf Mutu:='C'
else if (nilai<40) and (niali>55) then
Huruf_Mutu:='D'
else if (nilai<0) and (niali>40) then
Huruf_Mutu:'E'
